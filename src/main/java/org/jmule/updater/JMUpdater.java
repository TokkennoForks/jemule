...
public class JMUpdater {
	...
	static {
		error_codes.put(301, Localizer.getString("updaterwindow.error301"));
		error_codes.put(400, Localizer.getString("updaterwindow.error400"));
		error_codes.put(401, Localizer.getString("updaterwindow.error401"));
		error_codes.put(403, Localizer.getString("updaterwindow.error403"));
		error_codes.put(404, Localizer.getString("updaterwindow.error404"));
		error_codes.put(408, Localizer.getString("updaterwindow.error408"));
		error_codes.put(500, Localizer.getString("updaterwindow.error500"));
		error_codes.put(503, Localizer.getString("updaterwindow.error503"));
	}
