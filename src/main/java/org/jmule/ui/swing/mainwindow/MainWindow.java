...
public class MainWindow extends JFrame implements WindowListener  {
			    ...
			    SwingUtilities.invokeLater(new Runnable() {
				    ...
				    public void run() {
				         JOptionPane.showMessageDialog(_this, 
				            ...
				            Localizer.getString("mainwindow.not_enough_space_dialog.title"),JOptionPane.ERROR_MESSAGE);
				    }
			    });
			  }
			}
	...
	private void setMainMenu() {
		...
		file.setText(Localizer.getString("mainwindow.mainmenu.file"));
		fnew.setText("New");
		view.setText(Localizer.getString("mainwindow.mainmenu.view"));
		tabs.setText(Localizer.getString("mainwindow.mainmenu.view.tabs"));
		tools.setText(Localizer.getString("mainwindow.mainmenu.tools"));
		help.setText(Localizer.getString("mainwindow.mainmenu.help"));
		
		exit.setText(Localizer.getString("mainwindow.mainmenu.file.exit"));
		...
		import_server_list.setText(Localizer.getString("mainwindow.mainmenu.file.import"));
		import_server_list.setIcon(ImgRep.getIcon("import.png"));
		servers.setText(Localizer.getString("mainwindow.mainmenu.view.tabs.servers"));
		...
		transfers.setText(Localizer.getString("mainwindow.mainmenu.view.tabs.transfers"));
		...
		search.setText(Localizer.getString("mainwindow.mainmenu.view.tabs.search"));
		...
		shared_files.setText(Localizer.getString("mainwindow.mainmenu.view.tabs.shared"));
		...
		stats.setText(Localizer.getString("mainwindow.mainmenu.view.tabs.stats"));
		...
		logs.setText(Localizer.getString("mainwindow.mainmenu.view.tabs.logs"));
		...
		ui_chooser.setText(Localizer.getString("mainwindow.mainmenu.tools.uichooser"));
		...
		config_wizard.setText(Localizer.getString("mainwindow.mainmenu.tools.wizard"));
		...
		options.setText(Localizer.getString("mainwindow.mainmenu.tools.options"));
		...
		about.setText(Localizer.getString("mainwindow.mainmenu.help.about"));
		about.setIcon(ImgRep.getIcon("menuicons/information.png"));
		
		tool_bar_visibility.setText(Localizer.getString("mainwindow.mainmenu.view.toolbar"));
        status_bar_visibility.setText(Localizer.getString("mainwindow.mainmenu.view.statusbar"));
	...
	public enum ServerStatusTypes {
		DISCONNECTED { public String toString() { return Localizer.getString("mainwindow.statusbar.label.disconnected"); } },
		CONNECTING { public String toString() { return Localizer.getString("mainwindow.statusbar.label.connecting"); }	},
		CONNECTED { public String toString() { return Localizer.getString("mainwindow.statusbar.label.connected"); } };
		public abstract String toString();
	}
	
	public enum ClientIDTypes {
		LOW_ID { public String toString() { return Localizer.getString("mainwindow.statusbar.label.low_id"); } },
		HIGH_ID { public String toString() { return Localizer.getString("mainwindow.statusbar.label.high_id"); } },
	...
	class StatusBar extends JPanel implements Refreshable {
		...
		private JLabel server_status = new JLabel(Localizer.getString("mainwindow.statusbar.label.disconnected"));
