...
public class SearchResultTable extends JMTable {
	...
	private void init() {
		...
		file_name.setHeaderValue(Localizer.getString("mainwindow.searchtab.column.filename"));
		...
		file_size.setHeaderValue(Localizer.getString("mainwindow.searchtab.column.filesize"));
		...
		availability.setHeaderValue(Localizer.getString("mainwindow.searchtab.column.availability"));
		...
		complete_sources.setHeaderValue(Localizer.getString("mainwindow.searchtab.column.completesrcs"));
		...
		type.setHeaderValue(Localizer.getString("mainwindow.searchtab.column.filetype"));
		...
		file_id.setHeaderValue(Localizer.getString("mainwindow.searchtab.column.fileid"));
