...
public class StatisticsTabs extends AbstractTab {
	...
	private void init() {
		...
		java_panel.name_value.setText("No available");
		java_panel.vendor_value.setText("No available");
		java_panel.version_value.setText("No available");
	...
	private void updateData() {
		...
		java_panel.uptime_value.setText("No available");
		
		java_heap_memory_panel.initial_heap_memory_value.setText("No available");
		java_heap_memory_panel.used_heap_memory_value.setText("No available");
		java_heap_memory_panel.maximum_heap_memory_value.setText("No available");
		
		java_non_heap_momory_panel.initial_non_heap_memory_value.setText("No available");
		java_non_heap_momory_panel.used_non_heap_momory_value.setText("No available");
		java_non_heap_momory_panel.maximum_non_heap_memory_value.setText("No available");
		
		java_threads_panel.jmule_threads_value.setText("No available");
		java_threads_panel.daemon_threads_value.setText("No available");
		java_threads_panel.peak_threads_value.setText("No available");
		java_threads_panel.total_threads_value.setText("No available");
	}
