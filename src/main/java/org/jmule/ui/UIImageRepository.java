...
UIImageRepository
{
	...
	getImageAsStream(
			String	name ) 
	{
		InputStream input_stream = (UIImageRepository.class.getClassLoader().getResourceAsStream("" + name));
		if ( input_stream == null )
			input_stream = (UIImageRepository.class.getClassLoader().getResourceAsStream("image_not_found.png"));
		return input_stream;
	}
	
	public static String getImagePath(FileQuality fileQuality) {
		String path="file_quality/";
