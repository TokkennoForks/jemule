...
public class Toolbar extends ToolBar {
	...
	public Toolbar(Composite shell,JMuleCore core, MainWindow mainWindow) {
		...
		servers_item.setText(Localizer.getString("mainwindow.toolbar.servers_item"));
		...
		kad_item.setText(Localizer.getString("mainwindow.toolbar.kad_item"));
		...
		transfers_item.setText(Localizer.getString("mainwindow.toolbar.transfers_item"));
		...
		search_item.setText(Localizer.getString("mainwindow.toolbar.search_item"));
		...
		shared_item.setText(Localizer.getString("mainwindow.toolbar.shared_item"));
		...
		statistics_item.setText(Localizer.getString("mainwindow.toolbar.statistics_item"));
		...
		logs_item.setText(Localizer.getString("mainwindow.toolbar.logs_item"));
