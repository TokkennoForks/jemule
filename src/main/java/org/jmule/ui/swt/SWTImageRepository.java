...
public class SWTImageRepository {
	...
	public static Image getImage(String	name ) {
		InputStream input_stream = (SWTImageRepository.class.getClassLoader().getResourceAsStream("" + name));
		if ( input_stream == null )
			input_stream = (SWTImageRepository.class.getClassLoader().getResourceAsStream("image_not_found.png"));
	...
	public static Image getMenuImage(String name) {
		InputStream input_stream = (SWTImageRepository.class.getClassLoader().getResourceAsStream("menuicons/" + name));
		if ( input_stream == null )
			input_stream = (SWTImageRepository.class.getClassLoader().getResourceAsStream("image_not_found.png"));
		Image image = new Image(SWTThread.getDisplay(),input_stream);
		try {
