...
public class TableColumnEditorWindow {
  ...
  public TableColumnEditorWindow(final Table editTable,Shell parent,
	...
	shell.setText(Localizer.getString("columneditorwindow.title"));
    ...
    label.setText(Localizer.getString("columneditorwindow.draghint"));
    ...
    bOk.setText(Localizer.getString("mainwindow.button.ok"));
    rd = new RowData();
    rd.width = 70;
    ...
    bCancel.setText(Localizer.getString("mainwindow.button.cancel"));
    rd = new RowData();
    rd.width = 70;
    ...
    bApply.setText(Localizer.getString("mainwindo.button.apply"));
    rd = new RowData();
    rd.width = 70;
    ...
    column.setText(Localizer.getString("columneditorwindow.column.column_name"));
    column = new TableColumn(table, SWT.NONE);
    column.setText(Localizer.getString("columneditorwindow.column.description"));
