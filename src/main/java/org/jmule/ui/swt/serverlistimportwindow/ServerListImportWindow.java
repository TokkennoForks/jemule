...
public class ServerListImportWindow implements JMuleUIComponent{
	...
	public void initUIComponents() {
		...
		shell.setText(Localizer.getString("serverlistimportwindow.title"));
		...
		label.setText(Localizer.getString("serverlistimportwindow.label.file_path")+" : ");
		...
		browse_button.setText(Localizer.getString("serverlistimportwindow.button.browse"));
		...
		ok_button.setText(Localizer.getString("serverlistimportwindow.button.ok"));
		...
		cancel_button.setText(Localizer.getString("serverlistimportwindow.button.cancel"));
		...
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				try {
					...
					Utils.showWarningMessage(shell, Localizer.getString("serverlistimportwindow.import_failed_title"),
							Localizer.getString("serverlistimportwindow.import_failed")+"\n"+e.getLocalizedMessage());
				}
