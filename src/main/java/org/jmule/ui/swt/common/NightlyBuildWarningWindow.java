...
public class NightlyBuildWarningWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		shell.setText(Localizer.getString("nightlybuildwarningwindow.title"));
		...
		window_message.setText(Localizer.getString("nightlybuildwarningwindow.label.message1"));
		...
		MouseAdapter link_listener = new MouseAdapter() {
			public void mouseDoubleClick(MouseEvent arg0) {
				...
				if (!Utils.launchProgram(path)) 
					Utils.showWarningMessage(shell, Localizer.getString("nightlybuildwarningwindow.error_open_url.title")
							, Localizer.getString("nightlybuildwarningwindow.error_open_url",path));
			}
		...
		window_message2.setText(Localizer.getString("nightlybuildwarningwindow.label.message2")+" " + (Localizer.getString("nightlybuildwarningwindow.label.forum")));
		...
		button_check.setText(Localizer.getString("nightlybuildwarningwindow.label.show_at_startup"));
		...
		button.forceFocus();
		button.setText(Localizer.getString("nightlybuildwarningwindow.button.ok"));
