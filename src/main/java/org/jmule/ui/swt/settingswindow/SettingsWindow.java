...
public class SettingsWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		shell.setText(Localizer.getString("settingswindow.title"));
		...
		button_ok.setText(Localizer.getString("settingswindow.button.ok"));
		...
		button_cancel.setText(Localizer.getString("settingswindow.button.cancel"));
		...
		button_apply.setText(Localizer.getString("settingswindow.button.apply"));
