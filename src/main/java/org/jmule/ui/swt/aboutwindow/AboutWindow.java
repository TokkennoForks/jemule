...
public class AboutWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		MouseAdapter link_listener = new MouseAdapter() {
			public void mouseDoubleClick(MouseEvent arg0) {
				...
				if (!Utils.launchProgram(path)) 
					Utils.showWarningMessage(shell, Localizer.getString("aboutwindow.error_open_url.title")
							, Localizer.getString("aboutwindow.error_open_url",path));
			}
		...
		general_tab.setText(Localizer.getString("aboutwindow.tab.general"));
		layout = new GridLayout(1,false);
		layout.marginTop +=10;
		...
		about_text.setText(Localizer.getString("aboutwindow.tab.general.label.about"));
		...
		link.setText(Localizer.getString("aboutwindow.tab.general.label.home_page") + " : ");
		link = new CLabel(links_container,SWT.NONE);
		...
		link = new CLabel(links_container,SWT.NONE);
		link.setText(Localizer.getString("aboutwindow.tab.general.label.forum") + " : ");
		...
		if (JMConstants.IS_NIGHTLY_BUILD) {
			...
			nightly_build.setText(Localizer.getString("aboutwindow.tab.nightly_build"));
			layout = new GridLayout(1,false);
			...
			nightly_build_label.setText(Localizer.getString("aboutwindow.tab.nightly_build.label.nightly_buld_str1"));
			...
			nightly_build_label2.setText(Localizer.getString("aboutwindow.tab.nightly_build.label.nightly_buld_str2")+" "+ Localizer.getString("aboutwindow.tab.general.label.forum"));
		...
		environment_tab.setText(Localizer.getString("aboutwindow.tab.environment"));
		...
		table.addColumn(SWT.LEFT, 1, Localizer.getString("aboutwindow.tab.environment.table.column.key"), "", 200);
		table.addColumn(SWT.LEFT, 2, Localizer.getString("aboutwindow.tab.environment.table.column.value"), "", 500);
		...
		license_tab.setText(Localizer.getString("aboutwindow.tab.license"));
		...
		button_ok.setText(Localizer.getString("aboutwindow.button.ok"));
		...
		shell.setText(Localizer.getString("aboutwindow.title"));
