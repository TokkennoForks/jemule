...
public class SharedFilePropertiesWindow implements JMuleUIComponent {
	...
	public void getCoreComponents() {
		...
		shell.setText(Localizer.getString("sharedfilepropertieswindow.title"));
		...
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.filename")+" : ");
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.filesize")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.filepath")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.filestype")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.file_hash")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.completed")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.ed2k_link") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setToolTipText(Localizer.getString("sharedfilepropertieswindow.label.ed2k_link.tooltip"));
		label.setForeground(SWTThread.getDisplay().getSystemColor(SWT.COLOR_BLUE));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("sharedfilepropertieswindow.label.file_quality") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		file_quality_combo.add(Localizer.getString("sharedfilepropertieswindow.label.fq_not_rated"));
		file_quality_combo.setData(Localizer.getString("sharedfilepropertieswindow.label.fq_not_rated"), FileQuality.NOTRATED);
		
		file_quality_combo.add(Localizer.getString("sharedfilepropertieswindow.label.fq_fake"));
		file_quality_combo.setData(Localizer.getString("sharedfilepropertieswindow.label.fq_fake"), FileQuality.FAKE);
		
		file_quality_combo.add(Localizer.getString("sharedfilepropertieswindow.label.fq_poor"));
		file_quality_combo.setData(Localizer.getString("sharedfilepropertieswindow.label.fq_poor"), FileQuality.POOR);
		
		file_quality_combo.add(Localizer.getString("sharedfilepropertieswindow.label.fq_fair"));
		file_quality_combo.setData(Localizer.getString("sharedfilepropertieswindow.label.fq_fair"), FileQuality.FAIR);
		
		file_quality_combo.add(Localizer.getString("sharedfilepropertieswindow.label.fq_good"));
		file_quality_combo.setData(Localizer.getString("sharedfilepropertieswindow.label.fq_good"), FileQuality.GOOD);
		
		file_quality_combo.add(Localizer.getString("sharedfilepropertieswindow.label.fq_excellent"));
		file_quality_combo.setData(Localizer.getString("sharedfilepropertieswindow.label.fq_excellent"), FileQuality.EXCELLENT);
		...
		button_ok.setText(Localizer.getString("sharedfilepropertieswindow.button.ok"));
		...
		button_cancel.setText(Localizer.getString("sharedfilepropertieswindow.button.cancel"));
