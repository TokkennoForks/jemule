...
public class SearchPropertiesWindow implements JMuleUIComponent {
	...
	public SearchPropertiesWindow(SearchResultItem item) {
		...
		shell.setText(Localizer.getString("searchpropertieswindow.title"));
		...
		label.setText(Localizer.getString("searchpropertieswindow.label.filename")+" : ");
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("searchpropertieswindow.label.filesize")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("searchpropertieswindow.label.availability")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("searchpropertieswindow.label.completesrc")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("searchpropertieswindow.label.type")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("searchpropertieswindow.label.filehash")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setToolTipText(Localizer.getString("searchpropertieswindow.label.ed2k_link.tooltip"));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("searchpropertieswindow.label.filequality") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		switch(search_result.getFileQuality()) {
			case FAKE : label.setText(Localizer.getString("searchpropertieswindow.label.fq_fake")); break;
			case POOR : label.setText(Localizer.getString("searchpropertieswindow.label.fq_poor")); break;
			case FAIR : label.setText(Localizer.getString("searchpropertieswindow.label.fq_fair")); break;
			case GOOD : label.setText(Localizer.getString("searchpropertieswindow.label.fq_good")); break;
			case EXCELLENT : label.setText(Localizer.getString("searchpropertieswindow.label.fq_excellent")); break;
			default : label.setText(Localizer.getString("searchpropertieswindow.label.fq_not_rated")); break;
		}
		...
		button.setText(Localizer.getString("searchpropertieswindow.button.close"));
