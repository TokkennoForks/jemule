...
public class ServerMessages extends Text {
	...
	public ServerMessages(Composite composite) {
		...
		copy_selected.setText(Localizer.getString("mainwindow.serverlisttab.servermesasges.popupmenu.copy"));
		...
		select_all.setText(Localizer.getString("mainwindow.serverlisttab.servermesasges.popupmenu.select_all"));
		...
		clear.setText(Localizer.getString("mainwindow.serverlisttab.servermesasges.popupmenu.clear"));
