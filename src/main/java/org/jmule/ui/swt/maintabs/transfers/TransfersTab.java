	...
	public TransfersTab(Composite shell,JMuleCore core) {
		...
		refreshable = new Refreshable() {
			public void refresh() {
				...
				downloads.setText(Localizer.getString("mainwindow.transferstab.downloads")+"("+download_count+")");
				uploads.setText(Localizer.getString("mainwindow.transferstab.uploads")+"("+upload_count+")");
			}
		};
		refreshable.refresh();
	}
