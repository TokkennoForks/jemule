 ...
 * Last changed by $Author: binary255 $ on $Date: 2009/05/09 10:55:31 $
 */
public abstract class AdvancedSearchWindow implements JMuleUIComponent{
	...
	public void initUIComponents() {
		...
		shell.setText(Localizer.getString("advancedsearchwindow.title"));
		...
		label.setText(Localizer.getString("advancedsearchwindow.label.min_size") + " : ");
		...
		label = new Label(file_size_options,SWT.NONE);
		label.setText(Localizer.getString("advancedsearchwindow.label.max_size") + " : ");
		...
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.any"));
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.archive"));
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.audio"));
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.cd_image"));
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.document"));
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.pictures"));
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.program"));
		file_type.add(Localizer.getString("advancedsearchwindow.file_type.video"));
		...
		label = new Label(options_composite,SWT.NONE);
		label.setText(Localizer.getString("advancedsearchwindow.label.extension") + " : ");
		layout_data = new GridData();
		layout_data.horizontalAlignment = SWT.RIGHT;
		label.setLayoutData(layout_data);
		...
		label = new Label(options_composite,SWT.NONE);
		label.setText(Localizer.getString("advancedsearchwindow.label.availability") + " : ");
		layout_data = new GridData();
		layout_data.horizontalAlignment = SWT.RIGHT;
		label.setLayoutData(layout_data);
		...
		label = new Label(options_composite,SWT.NONE);
		label.setText(Localizer.getString("advancedsearchwindow.label.complete_sources") + " : ");
		layout_data = new GridData();
		layout_data.horizontalAlignment = SWT.RIGHT;
		label.setLayoutData(layout_data);
		...
		button_clear.setText(Localizer.getString("advancedsearchwindow.button.clear"));
		...
		button_ok.setText(Localizer.getString("advancedsearchwindow.button.ok"));
		...
		button_cancel.setText(Localizer.getString("advancedsearchwindow.button.cancel"));
