...
public class AlreadyExistDirsWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		shell.setText(Localizer.getString("alreadyexistdirswindow.title"));
		
		shell.setLayout(new GridLayout(1,false));
		
		Label info = new Label(shell,SWT.NONE);
		info.setFont(skin.getLabelFont());
		info.setText(Localizer.getString("alreadyexistdirswindow.label.info"));
		...
		button_ok.setText(Localizer.getString("alreadyexistdirswindow.button.ok"));
