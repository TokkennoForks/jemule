...
public class LogsTab extends AbstractTab implements Logger {
	...
	public LogsTab(Composite shell) {
		...
		copy_item.setText(Localizer.getString("mainwindow.logtab.popupmenu.copy"));
		...
		save_item.setText(Localizer.getString("mainwindow.logtab.popupmenu.save"));
		...
		select_all_item.setText(Localizer.getString("mainwindow.logtab.popupmenu.select_all"));
		...
		clear_item.setText(Localizer.getString("mainwindow.logtab.popupmenu.clear"));
