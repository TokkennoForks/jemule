	...
	public StatisticsTab(Composite shell) {
		...
		refreshable = new Refreshable() {
			...
			public void refresh() {
				...
				jvm_uptime.setText("No available");
				
				heapmemory_init.setText("No available");
				heapmemory_used.setText("No available");
				heapmemory_max.setText("No available");
				
				nonheapmemory_init.setText("No available");
				nonheapmemory_used.setText("No available");
				nonheapmemory_max.setText("No available");
				
				thread_count.setText("No available");
				daemon_thread_count.setText("No available");
				peak_thread_count.setText("No available");
				total_thread_count.setText("No available");
			}
		};
		...
		network_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.general"));
		...
		sessions_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.general.group.sessions"));
		...
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.session_downloaded") + " : ");
		...
		label = new Label(sessions_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.session_uploaded") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sessions_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.session_download_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sessions_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.session_upload_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		peers_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.general.group.peers"));
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.peer_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(peers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.download_peers") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(peers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.upload_peers") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		sesvers_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.general.group.servers"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL | GridData.VERTICAL_ALIGN_BEGINNING );
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.server_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sesvers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.server_alive_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sesvers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.server_dead_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sesvers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.search_query_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		sharing_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.general.group.shared"));
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.shared_files_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.shared_partial_files") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.shared_completed_files") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.shared_files_bytes") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.completed_files_bytes") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.general.label.partial_files_bytes") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		jvm_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm"));
		content = new Composite(stats_tabs,SWT.NONE);
		jvm_stats.setControl(content);
		content.setLayout(new GridLayout(2,true));
		
		Group jvm_general_stats = new Group(content,SWT.NONE);
		jvm_general_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.group.general"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.jvm_name") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		
		label = new Label(jvm_general_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText("No available");
		
		label = new Label(jvm_general_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.jvm_vendor") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(jvm_general_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.jvm_version") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(jvm_general_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.jvm_uptime") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		heapmemory_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.group.heap_memory"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.heapmemory_init") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(heapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.heapmemory_used") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(heapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.heapmemory_max") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		nonheapmemory_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.group.nonheap_memory"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.nonheapmemory_init") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(nonheapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.nonheapmemory_used") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(nonheapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.nonheapmemory_max") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		thread_stats.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.group.threads"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.thread_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(thread_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.daemon_thread_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(thread_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.peak_thread_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(thread_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.total_thread_count") + " : ");
		label.setToolTipText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.total_thread_count.tooltip"));
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		
		total_thread_count = new Label(thread_stats,SWT.NONE);
		total_thread_count.setFont(skin.getLabelFont());
		total_thread_count.setText("No available");
		total_thread_count.setToolTipText(Localizer.getString("mainwindow.statisticstab.tab.jvm.label.total_thread_count.tooltip"));
