...
public class SharedTab extends AbstractTab {
	...
	public SharedTab(Composite shell,JMuleCore core) {
		...
		if (dir != null)
			dir_list_content.setText(Localizer.getString("mainwindow.sharedtab.group.shared_dirs")+"("+dir.size()+")");
		else
			dir_list_content.setText(Localizer.getString("mainwindow.sharedtab.group.shared_dirs")+"(0)");
		
		config_listener = new ConfigurationAdapter() {
			public void sharedDirectoriesChanged(java.util.List<File> sharedDirs) {
				dir_list_content.setText(Localizer.getString("mainwindow.sharedtab.group.shared_dirs")+"("+sharedDirs.size()+")");
			}
		};
		...
		add_button.setText(Localizer.getString("mainwindow.sharedtab.button.add"));
		...
		remove_button.setText(Localizer.getString("mainwindow.sharedtab.button.remove"));
		...
		clear_button.setText(Localizer.getString("mainwindow.sharedtab.button.clear"));
		...
		reload_button.setText(Localizer.getString("mainwindow.sharedtab.button.reload"));
		...
		shared_files_group.setText(Localizer.getString("mainwindow.sharedtab.group.shared_files"));
		...
		shared_files_table = new JMTable<SharedFile>(shared_files_group, SWT.NONE){
			...
			public void updateRow(SharedFile object) {
				...
				if (status == HASHED) {
					...
					if (status == HASHING)
						setRowText(object,SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID, Localizer.getString("mainwindow.sharedtab.label.hashing"));
					else
						setRowText(object,SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID, Localizer.getString("mainwindow.sharedtab.label.waiting_to_hash"));
			}
	  ...
	  shared_files_table.addColumn(SWT.LEFT,  SWTConstants.SHARED_LIST_FILE_NAME_COLUMN_ID, Localizer.getString("mainwindow.sharedtab.column.filename"), "", width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_FILE_SIZE_COLUMN_ID);
	  shared_files_table.addColumn(SWT.RIGHT, SWTConstants.SHARED_LIST_FILE_SIZE_COLUMN_ID, Localizer.getString("mainwindow.sharedtab.column.filesize"), "", width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_FILE_TYPE_COLUMN_ID);
	  shared_files_table.addColumn(SWT.LEFT,  SWTConstants.SHARED_LIST_FILE_TYPE_COLUMN_ID, Localizer.getString("mainwindow.sharedtab.column.filetype"), "",width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID);
	  shared_files_table.addColumn(SWT.LEFT,  SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID,   Localizer.getString("mainwindow.sharedtab.column.fileid"), "", width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_COMPLETED_COLUMN_ID);
	  shared_files_table.addColumn(SWT.RIGHT,  SWTConstants.SHARED_LIST_COMPLETED_COLUMN_ID, Localizer.getString("mainwindow.sharedtab.column.completed"), "", width);
	  ...
	  column_setup_menu_item.setText(Localizer.getString("mainwindow.sharedtab.popupmenu.column_setup"));
	  ...
	  open_selected_menu_item.setText(Localizer.getString("mainwindow.sharedtab.popupmenu.open"));
	  ...
	  copy_ed2k_link_menu_item.setText(Localizer.getString("mainwindow.sharedtab.popupmenu.copy_ed2k_link"));
	  ...
	  remove_from_disk_menu_item.setText(Localizer.getString("mainwindow.sharedtab.popupmenu.remove_from_disk"));
	  ...
	  selected_column_setup_menu_item.setText(Localizer.getString("mainwindow.sharedtab.popupmenu.column_setup"));
	  ...
	  rating_menu_item.setText(Localizer.getString("mainwindow.searchtab.popupmenu.rating_submenu"));
	  ...
	  file_not_rated.setText(Localizer.getString("mainwindow.searchtab.popupmenu.rating_submenu.not_rated"));
	  ...
	  file_fake.setText(Localizer.getString("mainwindow.searchtab.popupmenu.rating_submenu.fake"));
	  ...
	  file_poor.setText(Localizer.getString("mainwindow.searchtab.popupmenu.rating_submenu.poor"));
	  ...
	  file_fair.setText(Localizer.getString("mainwindow.searchtab.popupmenu.rating_submenu.fair"));
	  ...
	  file_good.setText(Localizer.getString("mainwindow.searchtab.popupmenu.rating_submenu.good"));
	  ...
	  file_excellent.setText(Localizer.getString("mainwindow.searchtab.popupmenu.rating_submenu.excellent"));
	  ...
	  properties_menu_item.setText(Localizer.getString("mainwindow.sharedtab.popupmenu.properties"));
	...
	refreshable = new Refreshable() {
		public void refresh() {
			...
			String text = Localizer.getString("mainwindow.sharedtab.group.shared_files");
			SharedFile hashing_file = sharing_manager.getCurrentHashingFile();
			if (hashing_file != null) {
				text +=" Hashing [";
	...
	private void removeSelectedDir() {
		if (!Utils.showConfirmMessage(getShell(), Localizer.getString("mainwindow.sharedtab.confirm_remove_shared_dir_title"),
				 Localizer.getString("mainwindow.sharedtab.confirm_remove_shared_dir"))) return ;
	...
	private void clearDirList() {
		if (!Utils.showConfirmMessage(getShell(), Localizer.getString("mainwindow.sharedtab.confirm_clear_dir_list_title"),
				 Localizer.getString("mainwindow.sharedtab.confirm_clear_dir_list"))) return ;
	...
	private void removeFromDisk() {
		if (!Utils.showConfirmMessage(getShell(), Localizer.getString("mainwindow.sharedtab.confirm_remove_from_disk_title"),
									 Localizer.getString("mainwindow.sharedtab.confirm_remove_from_disk"))) return ;
	...
	private void updateDirList(final java.util.List<File> directoryList) {
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				shared_dir_list.add(Localizer.getString("mainwindow.sharedtab.shared_dirs.incoming"));
				shared_dir_list.add(Localizer.getString("mainwindow.sharedtab.shared_dirs.partial"));
				shared_dir_list.add(Localizer.getString("mainwindow.sharedtab.shared_dirs.all"));
	...
	private void updateFileList(final String dir) {
		...
		file_list_updater = new JMThread() {
			...
			public void run() {
				...
				if (dir.equals(Localizer.getString("mainwindow.sharedtab.shared_dirs.partial"))) {
				...
				if (dir.equals(Localizer.getString("mainwindow.sharedtab.shared_dirs.incoming")))
					shared_dir = new File(ConfigurationManager.INCOMING_DIR);	
					
				if (!dir.equals(Localizer.getString("mainwindow.sharedtab.shared_dirs.all"))) {
